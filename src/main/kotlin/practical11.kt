fun main() {
    ...
    val secondMatrix = Matrix(arrayOf(intArrayOf(4,7),intArrayOf(-7,5), intArrayOf(0,5)),3,2)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(2,4), intArrayOf(8,4), intArrayOf(5,4)),3,2)
